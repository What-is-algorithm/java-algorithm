...
public class Maze {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 최단경로로 갔을 때, 지나온 칸 수를 출력하는 문제이므로 BFS
        // DFS는 끝 죄표까지 도달하기 위해 지나온 좌표만을 그때그때 기억하기 때문에
        // DFS로 탐색하여 지나온 칸 수는 최단 경로라는 보장이 없다.
        // 하지만 BFS는 모든 경로에 지나온 좌표에 대해 큐를 통해 각 좌표의 시작 좌표에서
        // 지나온 칸 수를 기억할 수 있기 때문에 최단 경로로 지나온 칸 수를 구할 수 있다.
